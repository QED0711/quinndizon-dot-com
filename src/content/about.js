...
const ABOUT_CONTENT = {
    ...
    fullBio: {
        tags: [
            ...
            paragraph("Quinn holds a Bachelors of Music in Composition from the College of Wooster, and both a Masters in Composition and a Masters in Orchestral Conducting from the University of Louisville. He currently resides in the Washington D.C. area and is a doctoral candidate in composition at the University of Maryland College Park. Since 2015, he has been the recipient of the distinguished Flagship Fellowship award, given to only ten incoming doctoral students across all disciplines at UMD."),
            ...
            paragraph("Quinn is also a self taught programmer and web developer. Much of his work in this field combines his passion for music and education with his fascination with technology. Among his creations are several sound installations, music composition tools, and web applications for use in the classroom."),
