...
const ABOUT_CONTENT = {
    ...
    shortBio: {
        tags: [
            paragraph("Quinn Dizon is a classically trained musician with nearly a decade of professional experience in arts management and music education. He holds two masters degrees – composition and orchestral conducting – and a doctorate in music composition. He currently lives and works near Washington D.C."),
            paragraph("Above all else, Quinn loves to create. In addition to his musical activities, he is a passionate and experienced programmer. Combining his many interests, Quinn has authored multiple music education web applications that are currently used in university level courses. "),
        ]
    },
    ...
    fullBio: {
        tags: [
            ...
            paragraph("As another avenue for his creative output, Quinn is also a passionate programmer and web developer. Much of his work in this field combines his passion for music and education with his fascination with technology. Among his creations are several sound installations, music composition tools, and web applications used in college level music theory classrooms."),
            htmlInsert(<hr/>),
